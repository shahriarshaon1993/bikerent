                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('app.bikes.index')
                                            @if ($bike->user_status == true)
                                                <form class="d-inline" method="POST" action="{{ route('app.user.bikes.deactive', $bike->id) }}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-danger" title="Pending">
                                                        <i class="fas fa-toggle-on"></i>
                                                    </button>
                                                </form>
                                            @else
                                                <form class="d-inline" method="POST" action="{{ route('app.user.bikes.active', $bike->id) }}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-info" title="Approved">
