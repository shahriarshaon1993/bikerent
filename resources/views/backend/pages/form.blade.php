                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" name="excerpt">{{ $page->excerpt ?? old('excerpt') }}</textarea>
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" name="meta_description">{{ $page->meta_description ?? old('meta_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('meta_keywords') is-invalid @enderror" name="meta_keywords">{{ $page->meta_keywords ?? old('meta_keywords') }}</textarea>
