        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="card-title">
                        Upload product
                        <a href="{{ route('user.profile.bike') }}" class="btn btn-sm btn-info">Back to list</a>
                    </h2>
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="{{ route('user.profile.bike.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-8">
