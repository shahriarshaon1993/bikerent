...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        notify()->success('Menus added', 'Success');
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        notify()->success('Menus updated', 'Success');
        return back();
    }
    ...
    public function destroy(Menu $menu)
    {
        ...
        if ($menu->deletable == true) {
            $menu->delete();
            notify()->success('Menu destroy', 'Success');
        } else {
            notify()->error('Sorry menu can not destroy system menu.', 'Error');
        }
